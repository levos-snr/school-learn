			...
			<div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Platform growth and engagement trends
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="space-y-2">
							<div className="flex items-center justify-between text-sm">
								...
								<span className="font-mono">
									+{dashboardStats.recentUsers} this month
								</span>
							</div>
						...
						<div className="space-y-2">
							<div className="flex items-center justify-between text-sm">
								...
								<span className="font-mono">
									{dashboardStats.engagementRate.toFixed(1)}%
								</span>
							</div>
				...
				<CardContent>
					<div className="space-y-4">
						...
						<div className="flex items-center gap-4 rounded-lg border p-3">
							...
							<div className="flex-1">
								<p className="font-medium text-sm">Course enrollments</p>
								<p className="text-muted-foreground text-xs">
						...
						<div className="flex items-center gap-4 rounded-lg border p-3">
							...
							<div className="flex-1">
								<p className="font-medium text-sm">Course completions</p>
								<p className="text-muted-foreground text-xs">
									Students are actively completing courses
								</p>
							</div>
