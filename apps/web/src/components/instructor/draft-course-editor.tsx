...
import { BookOpen, Clock, GripVertical, Plus, Trash2 } from "lucide-react";
...
export function DraftCourseEditor({
	courseId,
	onClose,
}: DraftCourseEditorProps) {
						...
						<Card>
							<CardHeader>
								<div className="flex items-center justify-between">
									...
									<Button onClick={addLesson} className="cursor-pointer gap-2">
						...
						<Card>
							...
							<CardContent className="space-y-6">
								...
								<div className="rounded-lg bg-muted p-4">
									<h4 className="mb-2 font-medium">Course Status</h4>
									<Badge
