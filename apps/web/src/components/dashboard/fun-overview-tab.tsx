...
export function FunOverviewTab({ onTabChange }: FunOverviewTabProps) {
	...
	const [studyInterval, setStudyInterval] = useState<NodeJS.Timeout | null>(
		null,
	);
	...
	const onlineFriends =
		friends?.filter((f) => f.status === "online").slice(0, 4) || [];
	...
	return (
		...
		>
			...
			>
				...
				<motion.div variants={itemVariants}>
					<Card className="border-0 bg-gradient-to-br from-purple-50 to-pink-50 shadow-lg dark:from-purple-950 dark:to-pink-950">
						<CardContent className="p-6">
							<div className="flex items-center justify-between">
								<div>
				...
				<motion.div variants={itemVariants}>
					<Card className="border-0 bg-gradient-to-br from-orange-50 to-red-50 shadow-lg dark:from-orange-950 dark:to-red-950">
						<CardContent className="p-6">
							<div className="flex items-center justify-between">
								<div>
					...
					<CardContent>
						<div className="flex items-center justify-between">
							<div className="text-center">
								<div className="mb-2 font-bold font-mono text-4xl text-indigo-600 dark:text-indigo-400">
											...
											<div className="flex-1">
												...
												<div className="mt-2">
													...
													<p className="mt-1 text-muted-foreground text-xs">
														...
														lessons • {course.progress}% complete
													</p>
												</div>
											</div>
											<Button
			...
			<motion.div variants={itemVariants}>
				<Card className="border-0 bg-gradient-to-r from-yellow-50 to-orange-50 shadow-xl dark:from-yellow-950 dark:to-orange-950">
					<CardHeader>
						<CardTitle className="flex items-center space-x-2">
					...
					<CardContent>
						<div className="grid grid-cols-1 gap-6 md:grid-cols-3">
							<div className="text-center">
								...
								<div className="mt-2">
									<Progress
										value={(overviewStats.xpPoints % 1000) / 10}
										className="h-2"
									/>
									<p className="mt-1 text-muted-foreground text-xs">
