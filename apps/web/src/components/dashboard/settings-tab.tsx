				...
				<div className="space-y-6 lg:col-span-2">
					...
					<Card>
						...
						<CardContent className="space-y-4">
							...
							<div className="flex items-center justify-between">
								<div>
									<Label htmlFor="deadline-notifications">
										Deadline Alerts
									</Label>
									<p className="text-muted-foreground text-sm">
										Get alerted about approaching deadlines
									</p>
								</div>
								<Switch
					...
					<Card>
						...
						<CardContent className="space-y-4">
							...
							<div className="flex items-center justify-between">
								<div>
									<Label htmlFor="progress-visible">
						...
						<CardContent className="space-y-4">
							<div className="space-y-2">
								...
								<Select
									...
									onValueChange={(value) =>
										setSettingsData((prev) => ({ ...prev, theme: value }))
									}
								>
									<SelectTrigger>
										<SelectValue />
						...
						<CardContent className="space-y-4">
							...
							<div className="space-y-2">
								...
								<Select
									...
									onValueChange={(value) =>
										setSettingsData((prev) => ({ ...prev, timezone: value }))
									}
								>
									<SelectTrigger>
										<SelectValue />
					...
					<Card>
						...
						<CardContent className="space-y-3">
							...
							<div className="flex justify-between">
								...
								<span className="font-medium text-sm">
									{currentUser.stats?.coursesCompleted || 0}
								</span>
							</div>
						</CardContent>
					</Card>
