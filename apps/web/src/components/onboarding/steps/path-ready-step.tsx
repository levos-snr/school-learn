					...
					<div className="relative">
						<div className="relative mx-auto h-32 w-32">
							...
							<div className="-translate-x-1/2 -translate-y-4 absolute top-0 left-1/2 transform">
								<div className="float-block flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-kenya-green to-green-600 shadow-lg">
							...
							{/* Floating elements */}
							<div className="float-block-delay-1 absolute top-4 right-0 h-4 w-6 rounded bg-yellow-400 shadow-lg" />
							<div className="float-block-delay-2 absolute top-8 left-0 h-6 w-4 rounded bg-green-400 shadow-lg" />
						</div>
					</div>
